                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images-2 slider-lg-image-2">
                                ...
                                <div class="easyzoom-style">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="{{asset('asset/images/product/single-product-01.webp')}}"
                                            class="poppu-img product-img-main-href">
                                            <img src="{{asset('asset/images/product/single-product-01.webp')}}"
                                ...
                                @for($i = 0; $i < 3; $i++)
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('asset/images/product/single-product-02.webp')}}"
                                                class="poppu-img">
                                                <img src="{{asset('asset/images/product/single-product-03.webp')}}"
                                                    class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="product-details-thumbs-2 slider-thumbs-2">
                                <div class="sm-image"><img src="{{asset('asset/images/product/small/1-100x100.webp')}}"
                                        alt="product image thumb" class="product-img-main-src"></div>
                                @for($i = 0; $i < 3; $i++);
                                    <div class="sm-image"><img src="{{asset('asset/images/product/small/2-100x100.webp')}}"
