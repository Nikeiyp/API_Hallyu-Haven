                ...
                <div class="col-lg-12 d-none d-md-block">
                    <div class="top-logo-area">
                        <div class="logo text-md-center">
                            <a href="{{route('home')}}"><img src="{{asset('asset/images/logo/logo.png')}}" alt="logo"
                                    style="width:40%"></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-right-items content__hidden d-none d-md-block">
                        <span class="phone-number font-lg-p" title="Call us for fast delivery">
                            <a href="#cfd"><i class="icon-telephone"></i>&nbsp;&nbsp;<small
                                    class="text-color-primary"><b>+(62) 8980170200</b></small></a>
                        </span>
                    </div>
                    <div class="logo__hidden text-start">
                        <a href="{{route('home')}}"><img src="{{asset('asset/images/logo/logo.png')}}" alt=""
                                style="height:40px"></a>
                    </div>
                </div>
                ...
                <div class="tab-content content-modal-box">
                    ...
                    <div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">
                        ...
                        <div id="form-login-loading" style="text-align:center;display:none">
                            <img src="{{asset('asset/images/bg/loading.gif')}}" style="width: 300px">
                        </div>
                    </div>
